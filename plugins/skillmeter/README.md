...
reinstalling the plugin or deleting its data. Each later wire chunk, including chunks split from a large batch, opens with
a `session_continuation` record that carries only the
