...
function identity() {
  ...
  return {salt,deviceId,policyStamp:JSON.stringify(policy.global),owner:hmac(salt,JSON.stringify([claims.iss,claims.aud,claims.sub,claims.github_id || claims.user_alt_id]))};
}
